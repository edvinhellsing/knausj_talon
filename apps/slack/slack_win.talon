...
(go | section | zone) next: key(f6)
(go | section | zone) (previous | last): key(shift-f6)
(go | slack | lack | like) [direct] messages: key(ctrl-shift-k)
(go | slack | lack | like) threads: key(ctrl-shift-t)
...
(go | slack | lack | like) (react | reaction): key(ctrl-shift-\)
