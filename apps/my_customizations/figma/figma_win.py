from talon import Context, actions, ctrl, imgui
ctx = Context()
ctx.matches = r"""
os: windows
app: Figma
...
class UserActions:
    ...
    def figma_zoom_reset(): actions.key('ctrl-0')
    ...
    def figma_bold(): actions.key('ctrl-b')
    def figma_underline(): actions.key('ctrl-u')
    def figma_strikethrough(): actions.key('shift-ctrl-x')
    def figma_transform_list(): actions.key('shift-ctrl-7')
    def figma_text_align_left(): actions.key('alt-ctrl-l')
    def figma_text_align_right(): actions.key('alt-ctrl-r')
    def figma_text_align_center(): actions.key('alt-ctrl-t')
    def figma_text_align_justified(): actions.key('alt-ctrl-j')
    def figma_adjust_font_size_up(): actions.key('shift-ctrl->')
    def figma_adjust_font_size_down(): actions.key('shift-ctrl-<')
    def figma_adjust_font_weight_up(): actions.key('alt-ctrl-.')
    def figma_adjust_font_weight_down(): actions.key('alt-ctrl-,')
    ...
    def figma_select_all(): actions.key('ctrl-a')
    def figma_select_inverse(): actions.key('shift-ctrl-a')
    ...
    def figma_select_children(): actions.key('enter')
    def figma_select_parent(): actions.key('shift-enter')
    def figma_select_next_sibling(): actions.key('tab')
    def figma_select_prev_sibling(): actions.key('shift-tab')
    def figma_group_selection(): actions.key('ctrl-g')
    def figma_ungroup_selection(): actions.key('shift-ctrl-g')
    def figma_frame_selection(): actions.key('ctrl-alt-g')
    def figma_toggle_hide_selection(): actions.key('ctrl-shift-h')
